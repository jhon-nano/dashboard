...
export const queryCarteraProveedores = (cartera_proveedores) => {
  return {
    type: TypesCartera.StoreConstants.QUERY_CARTERA_PROVEEDORES,
    cartera_proveedores: cartera_proveedores,
  };
};
