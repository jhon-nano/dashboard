...
class TypesCotizacion extends ModuloBase  {

  constructor(router: any, parentPath: string) {
    super(
      true,     // visible
      'receipt',  // icon
      'Cotizaciones', // nombreModulo
      `${parentPath}/cotizacion`, // path
      'Gestión de Cotizaciones.', // detalle
...
export default TypesCotizacion;