...
interface AuthModuloReportProps extends CustomContentProps {
  allowDownload?: boolean;
  data: any;
}

const AuthModuloReport = forwardRef<HTMLDivElement, AuthModuloReportProps>(
  ({ id, ...props }, ref) => {
      ...
      <SnackbarContent ref={ref} className={classes.root}>
        <Card className={classes.card} style={{ backgroundColor: theme.palette.warning.main }}>
          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            ...
            nombreModulo={'Modulo: '+props.data.nombreModulo} 
            detalle={
...
AuthModuloReport.displayName = "ReportComplete";

export default AuthModuloReport;
