import { ErrorTwoTone, GroupAddTwoTone, LooksOneTwoTone, SaveTwoTone } from '@mui/icons-material';
...
export default function UsuarioFormUpdate({
    usuario
}) {
    ...
    const { fields, append, prepend, remove, swap, move, insert } = useFieldArray({
        ...
        name: "modulos", // unique name for your Field Array
