...
export default function InventarioCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setInventario(initialValues.inventario);
    setSeparado(initialValues.separado);
    setCosto_promedio(initialValues.costo_promedio);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Inventario(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "InventarioCreateForm")}
      {...rest}
    >
      <TextField
        label="Inventario"
