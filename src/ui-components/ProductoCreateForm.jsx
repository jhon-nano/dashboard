...
export default function ProductoCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setNombreCorto(initialValues.nombreCorto);
    setIva(initialValues.iva);
    setVenta(initialValues.venta);
    setInsumos(initialValues.insumos);
    setPreparacion(initialValues.preparacion);
    setBarras(initialValues.barras);
    setPresentacion(initialValues.presentacion);
    setDescripcion(initialValues.descripcion);
    setCambio_precio(initialValues.cambio_precio);
    setDatos_producto(initialValues.datos_producto);
