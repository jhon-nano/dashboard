...
export default function ModuloUserAlmacenesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ModuloUserAlmacenes(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ModuloUserAlmacenesCreateForm")}
      {...rest}
    >
      <SelectField
        label="Estado"
