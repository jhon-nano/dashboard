...
export default function MarcaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setNombreMarca(initialValues.nombreMarca);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Marca(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MarcaCreateForm")}
      {...rest}
    >
      <TextField
        label="Nombre marca"
