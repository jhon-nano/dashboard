...
type EagerTercero = {
  readonly [__modelMeta__]: {
    identifier: ManagedIdentifier<Tercero, 'id'>;
    readOnlyFields: 'createdAt' | 'updatedAt';
  };
  readonly id: string;
  readonly tipo_tercero: TipoTerceros | keyof typeof TipoTerceros;
  readonly identificacion: string;
  readonly dv?: number | null;
  readonly expedida?: string | null;
  readonly lugar_nacimiento?: string | null;
  readonly fecha_nacimiento?: string | null;
  readonly nombre_completo: string;
  readonly primer_apellido?: string | null;
  readonly segundo_apellido?: string | null;
  readonly primer_nombre?: string | null;
  readonly segundo_nombre?: string | null;
  readonly direccion?: string | null;
  readonly telefono?: string | null;
  readonly ciudad?: string | null;
  readonly correo?: string | null;
  readonly datos_personales?: DatosSolicitud | null;
  readonly estado?: Estado | keyof typeof Estado | null;
  readonly createdAt?: string | null;
  readonly updatedAt?: string | null;
}
...
export declare type Tercero = LazyLoading extends LazyLoadingDisabled ? EagerTercero : LazyTercero

export declare const Tercero: (new (init: ModelInit<Tercero>) => Tercero) & {
  copyOf(source: Tercero, mutator: (draft: MutableModel<Tercero>) => MutableModel<Tercero> | void): Tercero;
}