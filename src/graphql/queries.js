...
`;
export const getTercero = /* GraphQL */ `
  query GetTercero($id: ID!) {
    getTercero(id: $id) {
      id
      tipo_tercero
      identificacion
...
`;
export const listTerceros = /* GraphQL */ `
  query ListTerceros(
    $filter: ModelTerceroFilterInput
    $limit: Int
    $nextToken: String
  ) {
    listTerceros(filter: $filter, limit: $limit, nextToken: $nextToken) {
      items {
        id
        tipo_tercero
        identificacion
...
`;
export const syncTerceros = /* GraphQL */ `
  query SyncTerceros(
    $filter: ModelTerceroFilterInput
    $limit: Int
    $nextToken: String
