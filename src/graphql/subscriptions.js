...
`;
export const onCreateTercero = /* GraphQL */ `
  subscription OnCreateTercero($filter: ModelSubscriptionTerceroFilterInput) {
    onCreateTercero(filter: $filter) {
      id
      tipo_tercero
      identificacion
      dv
...
`;
export const onUpdateTercero = /* GraphQL */ `
  subscription OnUpdateTercero($filter: ModelSubscriptionTerceroFilterInput) {
    onUpdateTercero(filter: $filter) {
      id
      tipo_tercero
      identificacion
      dv
...
`;
export const onDeleteTercero = /* GraphQL */ `
  subscription OnDeleteTercero($filter: ModelSubscriptionTerceroFilterInput) {
    onDeleteTercero(filter: $filter) {
      id
      tipo_tercero
      identificacion
      dv
